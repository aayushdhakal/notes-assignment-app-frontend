...
const NavigationBar = () => {
  return (
    <>
      <div className="navbar bg-fourth">
        <div className="flex-1">
          <a className="my-auto text-xl hover:bg-none">
            <Image className="my-auto  max-h-12 max-w-14 p-0 m-0 cursor-pointer" src={mainLogo} alt="Notes App Main logo" />
          </a>
        </div>
